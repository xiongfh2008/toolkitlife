...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.audio-converter.metadata" });
  return {
    title: t("title"),
    openGraph: {
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="audio-converter" locale={locale}>
      {children}
    </ToolMessages>
  );
}
