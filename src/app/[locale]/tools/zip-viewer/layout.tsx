...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/zip-viewer`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/zip-viewer`,
        "x-default": `https://www.toolkitlife.com/en/tools/zip-viewer`,
      },
    },
  };
}
