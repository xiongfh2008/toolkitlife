...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/pace-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/pace-calculator`,
        "x-default": `https://www.toolkitlife.com/en/tools/pace-calculator`,
      },
    },
  };
}
