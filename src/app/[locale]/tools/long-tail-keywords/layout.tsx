...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/long-tail-keywords`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/long-tail-keywords`,
        "x-default": `https://www.toolkitlife.com/en/tools/long-tail-keywords`,
      },
    },
  };
}
