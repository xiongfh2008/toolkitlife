...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/group-randomizer`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/group-randomizer`,
        "x-default": `https://www.toolkitlife.com/en/tools/group-randomizer`,
      },
    },
  };
}
