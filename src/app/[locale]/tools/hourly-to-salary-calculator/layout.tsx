...
export function generateStaticParams() {
  return [{ slug: "hourly-to-salary-calculator" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/hourly-to-salary-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/hourly-to-salary-calculator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="hourly-to-salary-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
