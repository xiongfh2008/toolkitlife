...
export function generateStaticParams() {
  return [{ slug: "weight-loss-calculator" }];
}
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.weight-loss-calculator.metadata" });
  return {
    title: t("title"),
    openGraph: {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: `https://www.toolkitlife.com/de/tools/weight-loss-calculator`,
        fr: `https://www.toolkitlife.com/fr/tools/weight-loss-calculator`,
        pt: `https://www.toolkitlife.com/pt/tools/weight-loss-calculator`,
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="weight-loss-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
