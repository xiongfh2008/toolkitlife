...
export function generateStaticParams() {
  return [{ slug: "image-alpha-invert" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/image-alpha-invert`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/image-alpha-invert`,
      },
    },
  };
}
