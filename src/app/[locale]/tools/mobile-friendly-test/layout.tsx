...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/mobile-friendly-test`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/mobile-friendly-test`,
        "x-default": `https://www.toolkitlife.com/en/tools/mobile-friendly-test`,
      },
    },
  };
}
