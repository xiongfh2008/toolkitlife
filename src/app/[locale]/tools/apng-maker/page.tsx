...
export default function ApngMakerPage() {
  const t = useTranslations("tools.apng-maker");
  ...
  const [resultName, setResultName] = useState("animation.apng");
  ...
  const convert = async () => {
    ...
    try {
      ...
      setResultName(`${file.name.replace(/\.[^.]+$/, "")}.apng`);
      setProgress(100);
      setStep("done");
    } catch (err) {
      console.error(err);
      ...
      <div className="max-w-4xl space-y-4">
        ...
        {step === "upload" && (
          <div
            ...
            onClick={() => document.getElementById("apng-in")?.click()}
        ...
        {step === "settings" && file && (
          <div className="space-y-4">
            ...
            <p className="text-xs text-zinc-500">{t("labels.note")}</p>
        ...
        {step === "done" && file && (
          <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6 text-center">
            ...
            <img src={resultUrl} alt="APNG" className="mx-auto mb-6 max-h-80 rounded-lg" />
