...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.file-transfer.metadata" });
  return {
    title: t("title"),
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/file-transfer`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/file-transfer`,
        "x-default": `https://www.toolkitlife.com/en/tools/file-transfer`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="file-transfer" locale={locale}>
      {children}
    </ToolMessages>
  );
}
