...
export function generateStaticParams() {
  return [{ slug: "color-contrast-checker" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/color-contrast-checker`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/color-contrast-checker`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="color-contrast-checker" locale={locale}>
      {children}
    </ToolMessages>
  );
}
