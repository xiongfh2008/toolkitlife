...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://www.toolkitlife.com/${locale}/tools/face-detector`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/face-detector`,
        "x-default": `https://www.toolkitlife.com/en/tools/face-detector`,
      },
    },
  };
}
