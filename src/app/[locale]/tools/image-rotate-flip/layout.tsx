...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.image-rotate-flip.metadata" });
  return {
    title: t("title"),
    openGraph: {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: `https://www.toolkitlife.com/de/tools/image-rotate-flip`,
        fr: `https://www.toolkitlife.com/fr/tools/image-rotate-flip`,
        pt: `https://www.toolkitlife.com/pt/tools/image-rotate-flip`,
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="image-rotate-flip" locale={locale}>
      {children}
    </ToolMessages>
  );
}
