...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.noise-generator.metadata" });
  return {
    title: t("title"),
    openGraph: {

      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/noise-generator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/noise-generator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="noise-generator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
