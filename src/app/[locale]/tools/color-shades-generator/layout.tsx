...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://www.toolkitlife.com/${locale}/tools/color-shades-generator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/color-shades-generator`,
        "x-default": `https://www.toolkitlife.com/en/tools/color-shades-generator`,
      },
    },
  };
}
