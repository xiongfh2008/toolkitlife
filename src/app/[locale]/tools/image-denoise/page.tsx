...
import { denoise } from "@/lib/image-enhance";

const MAX_DIM = 3000;

export default function ImageDenoisePage() {
  const t = useTranslations("tools.image-denoise");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      const out = denoise(src, radius, strength);
  ...
  }, [img, processing, radius, strength, t]);
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("denoise-in")?.click()}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {processing ? t("status.processing") : t("buttons.denoise")}
              </button>
              <button
