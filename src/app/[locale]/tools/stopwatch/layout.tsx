...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/stopwatch`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/stopwatch`,
        "x-default": `https://www.toolkitlife.com/en/tools/stopwatch`,
      },
    },
  };
}
