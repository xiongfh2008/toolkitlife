...
export function generateStaticParams() {
  return [{ slug: "waist-to-hip-ratio-calculator" }];
}
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.waist-to-hip-ratio-calculator.metadata" });
  return {
    title: t("title"),
    openGraph: {

      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/waist-to-hip-ratio-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/waist-to-hip-ratio-calculator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="waist-to-hip-ratio-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
