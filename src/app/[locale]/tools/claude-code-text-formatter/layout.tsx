...
export function generateStaticParams() {
  return [{ slug: "claude-code-text-formatter" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/claude-code-text-formatter`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/claude-code-text-formatter`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="claude-code-text-formatter" locale={locale}>
      {children}
    </ToolMessages>
  );
}
