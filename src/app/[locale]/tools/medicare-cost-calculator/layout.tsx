...
export function generateStaticParams() {
  return [{ slug: "medicare-cost-calculator" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/medicare-cost-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/medicare-cost-calculator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="medicare-cost-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
