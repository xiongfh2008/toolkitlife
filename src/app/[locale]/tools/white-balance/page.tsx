...
import { whiteBalance } from "@/lib/image-enhance";

const MAX_DIM = 3000;

export default function WhiteBalancePage() {
  const t = useTranslations("tools.white-balance");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      const out = whiteBalance(src, strength);
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("wb-in")?.click()}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {processing ? t("status.processing") : t("buttons.correct")}
              </button>
              <button
