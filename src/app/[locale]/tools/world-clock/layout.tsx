...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/world-clock`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/world-clock`,
        "x-default": `https://www.toolkitlife.com/en/tools/world-clock`,
      },
    },
  };
}
