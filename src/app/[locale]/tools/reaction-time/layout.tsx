...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/reaction-time`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/reaction-time`,
        "x-default": `https://www.toolkitlife.com/en/tools/reaction-time`,
      },
    },
  };
}
