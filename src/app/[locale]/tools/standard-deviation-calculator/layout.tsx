...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://www.toolkitlife.com/${locale}/tools/standard-deviation-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/standard-deviation-calculator`,
        "x-default": `https://www.toolkitlife.com/en/tools/standard-deviation-calculator`,
      },
    },
  };
}
