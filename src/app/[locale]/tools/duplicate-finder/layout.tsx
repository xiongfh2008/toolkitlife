...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.duplicate-finder.metadata" });
  return {
    title: t("title"),
    openGraph: {
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="duplicate-finder" locale={locale}>
      {children}
    </ToolMessages>
  );
}
