...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.image-border.metadata" });
  return {
    title: t("title"),
    openGraph: {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: `https://www.toolkitlife.com/de/tools/image-border`,
        fr: `https://www.toolkitlife.com/fr/tools/image-border`,
        pt: `https://www.toolkitlife.com/pt/tools/image-border`,
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="image-border" locale={locale}>
      {children}
    </ToolMessages>
  );
}
