...
import { oilPaint } from "@/lib/image-effects";

const MAX_DIM = 2000;

export default function ImageOilPaintPage() {
  const t = useTranslations("tools.image-oil-paint");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      ctx.putImageData(oilPaint(src, radius, levels), 0, 0);
      canvas.toBlob((blob) => {
        if (!blob) return;
  ...
  }, [img, processing, radius, levels, t]);
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("oil-in")?.click()}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {processing ? t("status.processing") : t("buttons.paint")}
              </button>
              <button
