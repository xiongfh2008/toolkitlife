...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://www.toolkitlife.com/${locale}/tools/ovulation-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/ovulation-calculator`,
        "x-default": `https://www.toolkitlife.com/en/tools/ovulation-calculator`,
      },
    },
  };
}
