...
export async function generateMetadata({
  ...
  return {
    title: t("title"),
    openGraph: {
      url: `https://www.toolkitlife.com/${locale}/tools/click-speed`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/click-speed`,
        "x-default": `https://www.toolkitlife.com/en/tools/click-speed`,
      },
    },
  };
}
