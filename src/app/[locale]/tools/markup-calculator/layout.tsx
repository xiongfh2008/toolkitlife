...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/markup-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        es: `https://www.toolkitlife.com/es/tools/markup-calculator`,
        de: `https://www.toolkitlife.com/de/tools/markup-calculator`,
        fr: `https://www.toolkitlife.com/fr/tools/markup-calculator`,
        pt: `https://www.toolkitlife.com/pt/tools/markup-calculator`,
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/markup-calculator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="markup-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
