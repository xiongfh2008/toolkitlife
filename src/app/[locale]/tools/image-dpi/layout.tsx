...
export async function generateMetadata({
  ...
  return {
    title: t("title"),
    openGraph: {
      url: `https://www.toolkitlife.com/${locale}/tools/image-dpi`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/image-dpi`,
        "x-default": `https://www.toolkitlife.com/en/tools/image-dpi`,
      },
    },
  };
}
