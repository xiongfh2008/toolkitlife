...
export function generateStaticParams() {
  return [{ slug: "water-intake-calculator" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/water-intake-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/water-intake-calculator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="water-intake-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
