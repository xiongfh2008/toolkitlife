...
import { deblur } from "@/lib/image-enhance";

const MAX_DIM = 3000;

export default function ImageDeblurPage() {
  const t = useTranslations("tools.image-deblur");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      const out = deblur(src, strength, iterations);
  ...
  }, [img, processing, strength, iterations, t]);
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("deblur-in")?.click()}
          ...
          <div className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label className="mb-1 block text-sm text-zinc-400">
                  {t("labels.iterations")}: {iterations}
                </label>
                <input
                  type="range"
                  min={1}
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {processing ? t("status.processing") : t("buttons.deblur")}
              </button>
              <button
