...
export async function generateMetadata({
  ...
  return {
    title: t("title"),
    openGraph: {
      url: `https://www.toolkitlife.com/${locale}/tools/web-icon`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/web-icon`,
        "x-default": `https://www.toolkitlife.com/en/tools/web-icon`,
      },
    },
  };
}
