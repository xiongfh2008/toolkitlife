...
export function generateStaticParams() {
  return [{ slug: "robots-txt-generator" }];
}
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.robots-txt-generator.metadata" });
  return {
    title: t("title"),
    openGraph: {
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="robots-txt-generator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
