...
export function generateStaticParams() {
  return [{ slug: "dui-cost-calculator" }];
}
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.dui-cost-calculator.metadata" });
  return {
    title: t("title"),
    openGraph: {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: `https://www.toolkitlife.com/de/tools/dui-cost-calculator`,
        fr: `https://www.toolkitlife.com/fr/tools/dui-cost-calculator`,
        pt: `https://www.toolkitlife.com/pt/tools/dui-cost-calculator`,
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="dui-cost-calculator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
