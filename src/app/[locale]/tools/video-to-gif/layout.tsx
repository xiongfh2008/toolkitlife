...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/video-to-gif`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/video-to-gif`,
        "x-default": `https://www.toolkitlife.com/en/tools/video-to-gif`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="video-to-gif" locale={locale}>
      {children}
    </ToolMessages>
  );
}
