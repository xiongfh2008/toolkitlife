...
import { dehaze } from "@/lib/image-enhance";

const MAX_DIM = 2500;

export default function DehazePage() {
  const t = useTranslations("tools.dehaze");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      const out = dehaze(src, strength, windowSize);
  ...
  }, [img, processing, strength, windowSize, t]);
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("dehaze-in")?.click()}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {processing ? t("status.processing") : t("buttons.dehaze")}
              </button>
              <button
