...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.pdf-to-jpg.metadata" });
  return {
    title: t("title"),
    openGraph: {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: `https://www.toolkitlife.com/de/tools/pdf-to-jpg`,
        fr: `https://www.toolkitlife.com/fr/tools/pdf-to-jpg`,
        pt: `https://www.toolkitlife.com/pt/tools/pdf-to-jpg`,
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="pdf-to-jpg" locale={locale}>
      {children}
    </ToolMessages>
  );
}
