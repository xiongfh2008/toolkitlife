...
import { histogramEqualize } from "@/lib/image-enhance";

const MAX_DIM = 3000;

export default function HistogramEqualizePage() {
  const t = useTranslations("tools.histogram-equalize");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      const out = histogramEqualize(src, strength);
  ...
  const handleDownload = () => {
    ...
    a.href = result;
    a.download = "histogram-equalized.png";
    a.click();
  };
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("he-in")?.click()}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {processing ? t("status.processing") : t("buttons.equalize")}
              </button>
              <button
