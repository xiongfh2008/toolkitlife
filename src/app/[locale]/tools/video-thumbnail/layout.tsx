...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.video-thumbnail.metadata" });
  return {
    title: t("title"),
    openGraph: {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: `https://www.toolkitlife.com/de/tools/video-thumbnail`,
        fr: `https://www.toolkitlife.com/fr/tools/video-thumbnail`,
        pt: `https://www.toolkitlife.com/pt/tools/video-thumbnail`,
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="video-thumbnail" locale={locale}>
      {children}
    </ToolMessages>
  );
}
