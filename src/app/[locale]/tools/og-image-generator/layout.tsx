...
export function generateStaticParams() {
  return [{ slug: "og-image-generator" }];
}
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/og-image-generator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/og-image-generator`,
        "x-default": `https://www.toolkitlife.com/en/tools/og-image-generator`,
      },
    },
  };
}
