...
import { hdrToneMapping } from "@/lib/image-enhance";

const MAX_DIM = 3000;

export default function HdrToneMappingPage() {
  const t = useTranslations("tools.hdr-tone-mapping");
  ...
  const process = useCallback(async () => {
    ...
    try {
      ...
      const out = hdrToneMapping(src, exposure, strength);
  ...
  }, [img, processing, exposure, strength, t]);
  ...
  const handleDownload = () => {
    ...
    a.href = result;
    a.download = "hdr-tone-mapped.png";
    a.click();
  };
      ...
      <div className="max-w-4xl space-y-4">
        {!img ? (
          <div
            ...
            onClick={() => document.getElementById("hdr-in")?.click()}
