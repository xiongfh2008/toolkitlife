...
export function generateStaticParams() {
  return [{ slug: "css-gradient-generator" }];
}
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.css-gradient-generator.metadata" });
  return {
    title: t("title"),
    openGraph: {

      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/css-gradient-generator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/css-gradient-generator`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="css-gradient-generator" locale={locale}>
      {children}
    </ToolMessages>
  );
}
