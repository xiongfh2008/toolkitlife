...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/amortization-calculator`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/amortization-calculator`,
        "x-default": `https://www.toolkitlife.com/en/tools/amortization-calculator`,
      },
    },
  };
}
