...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.json-formatter.metadata" });
  return {
    title: t("title"),
    openGraph: {

      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/json-formatter`,
    ...
    alternates: {
      ...
      languages: {
        ...
        "x-default": `https://www.toolkitlife.com/en/tools/json-formatter`,
      },
    },
  };
}
...
export default async function Layout({
  ...
  setRequestLocale(locale);
  return (
    <ToolMessages slug="json-formatter" locale={locale}>
      {children}
    </ToolMessages>
  );
}
