...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/svg-to-image`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/svg-to-image`,
        "x-default": `https://www.toolkitlife.com/en/tools/svg-to-image`,
      },
    },
  };
}
