...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      url: `https://www.toolkitlife.com/${locale}/tools/exif-cleaner`,
    ...
    alternates: {
      ...
      languages: {
        ...
        ru: `https://www.toolkitlife.com/ru/tools/exif-cleaner`,
        "x-default": `https://www.toolkitlife.com/en/tools/exif-cleaner`,
      },
    },
  };
}
